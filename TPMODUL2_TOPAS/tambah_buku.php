                    ...
                    <div class="card-body">
                        <form action="create.php" method="POST" enctype="multipart/form-data">
                            <div class="form-floating mb-3">
                                ...
                                <input type="string" class="form-control form-control-lg" name="judul" id="judul" placeholder="judul" required>
                                <label for="judul">Judul</label>
                            </div>
                            <div class="form-floating mb-3">
                                <!--  ==================2==================  -->
                                <!--  Buatlah input untuk penulis yang harus diisi; dengan label  -->
                                <input type="string" class="form-control" name="penulis" id="penulis" placeholder="penulis" required>
                                <label for="penulis">penulis</label>
                            </div>
                            <div class="form-floating mb-3">
                                <!--  ==================3==================  -->
                                <!--  Buatlah input untuk tahun_terbit yang harus diisi; dengan label  -->
                                <input type="string" class="form-control" name="tahun_terbit" id="tahun_terbit" placeholder="tahun_terbit" required>
