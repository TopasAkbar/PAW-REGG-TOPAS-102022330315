...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        } else{ $nama = (!ctype_alpha($_POST["nama"]));
        }}
...
if (empty($_POST["jurusan"])) {
    ...
    } elseif (!filter_var($_POST["jurusan"], )) {
        $jurusanErr = "jurusan hanya boleh berisi huruf";
    } else {
        $jurusanErr = !ctype_alpha($_POST["jurusan"]);
    }}
...
if (empty($_POST["fakultas"])) {
    ...
    } elseif (!filter_var($_POST["fakultas"], )) {
        $fakultasErr = "fakultas hanya boleh berisi huruf";
    } else {
        $fakultasErr = !ctype_alpha($_POST["fakultas"]);
    }
